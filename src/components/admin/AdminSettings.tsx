...
export const AdminSettings: React.FC = () => {
  const [settings, setSettings] = useState<AdminSettings>({
    ...
    referral_share_base_url: 'https://starline-networks.com/signup',
    ...
    try {
      ...
      if (settingsData) {
        ...
        setSettings({
          ...
          referral_share_base_url: settingsMap.referral_share_base_url || 'https://starline-networks.com/signup',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <Input
                  ...
                  placeholder="https://starline-networks.com/signup"
                />
                <Input
